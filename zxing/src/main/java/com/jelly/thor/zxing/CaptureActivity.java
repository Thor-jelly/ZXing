...
import com.jelly.thor.zxing.camera.CameraManager;
...
//
//        if (prefs.getBoolean(PreferencesConstant.KEY_DISABLE_AUTO_ORIENTATION, true)) {
...
//        copyToClipboard = prefs.getBoolean(PreferencesConstant.KEY_COPY_TO_CLIPBOARD, true)
...
//        lastResult = rawResult;
        ...
        //返回正确结果
        myHandleDecode(rawResult, barcode, scaleFactor);
...
//        }
     ...
     * 返回结果
     *
     * 如果需要连续调用，调用方法restartPreviewAndDecode
     */
    protected abstract void myHandleDecode(Result rawResult, Bitmap barcode, float scaleFactor);
